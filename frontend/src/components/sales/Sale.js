...
<center>
<p style={{padding: '1em'}} onClick={toggleAdd}><img  src='data:image/svg+xml;utf8,%3Csvg%20viewBox%3D%220%200%2020%2020%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M3%203h1V1H2.5A1.5%201.5%200%20001%202.5V4h2V3zM6%203h3V1H6v2zM11%203h3V1h-3v2zM9%2019H6v-2h3v2zM11%2019h3v-2h-3v2zM17%204V3h-1V1h1.5A1.5%201.5%200%200119%202.5V4h-2zM3%2017v-1H1v1.5A1.5%201.5%200%20002.5%2019H4v-2H3zM16%2017h1v-1h2v1.5a1.5%201.5%200%2001-1.5%201.5H16v-2zM10%206a1%201%200%20011%201v2h2a1%201%200%20110%202h-2v2a1%201%200%2011-2%200v-2H7a1%201%200%20110-2h2V7a1%201%200%20011-1zM1%209V6h2v3H1zM1%2011v3h2v-3H1zM17%209V6h2v3h-2zM17%2011v3h2v-3h-2z%22%20fill%3D%22%235C5F62%22%2F%3E%3C%2Fsvg%3E' width='30' height='30'/></p>
</center>
</Card>
...
<Stack>
  <Stack.Item fill>
          ...
          <h3>
      <TextStyle variation="strong" ><Link onClick={() => addLink(url, title, image, _id)}  url={url} external>{title}</Link></TextStyle>
          </h3>
          <div>{description}</div>
  </Stack.Item>

  <Stack.Item >
      {props.user.email == "hmurai@beautyandhair.com" || props.user.email == "dfluharty@beautyandhair.com" || props.user.email == "darren@beautyandhair.com" ? 
      <p   onClick={()=> toggleEdit(_id)}><img style={{cursor: 'pointer'}} width='15' height='15' src='data:image/svg+xml;utf8,%3Csvg%20viewBox%3D%220%200%2020%2020%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M14.846%201.403l3.752%203.753.625-.626A2.653%202.653%200%200015.471.778l-.625.625zm2.029%205.472l-3.752-3.753L1.218%2015.028%200%2019.998l4.97-1.217L16.875%206.875z%22%20fill%3D%22%235C5F62%22%2F%3E%3C%2Fsvg%3E%0A'/></p>
: ('')
    }
