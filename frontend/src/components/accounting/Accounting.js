...
export default function Accounting(props) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const result = await actions.listAccounting();
        ...
        <Page narrowWidth>
          <Card>
            <center>
              ...
              >
                <DisplayText size="large">The Accounting department</DisplayText>
              </div>
            </center>
          </Card>
          <ResourceList
                      ...
                      <Stack.Item fill>
                        <h3>
                          <TextStyle variation="strong">
                            <Link url={url} external  onClick={() => addLink(url, title, image, _id)}>
                              {title}
                            </Link>
                          </TextStyle>
                        </h3>
